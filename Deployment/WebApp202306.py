...
def main():
    ...
    with col1:
        ...
        availability = st.number_input(
            "Availability Score",
            min_value=limits["availability"][0]//0.01/100 if limits["availability"][1]!=0 else 0,
        ...
        Prob_VeryLikely = st.number_input(
            ...
            min_value=limits["Prob_VeryLikely"][0]//0.01/100 if limits["Prob_VeryLikely"][1]!=0 else 0,
        ...
        AffordScore_MA3 = st.number_input(
            ...
            min_value=limits["AffordScore_MA3"][0]//0.01/100 if limits["AffordScore_MA3"][1]!=0 else 0,
        ...
        RatioGasChargingCost_MA3 = st.number_input(
            ...
            min_value=limits["RatioGasChargingCost_MA3"][0]//0.01/100 if limits["RatioGasChargingCost_MA3"][1]!=0 else 0,
        ...
        ChargingPortsPerCapita = st.number_input(
            ...
            format="%.6f",
            step=1e-6,
            min_value=limits["ChargingPortsPerCapita"][0]//1e-6/1e6 if limits["ChargingPortsPerCapita"][1]!=0 else 0,
        ...
        Infr_avail = st.number_input(
            ...
            min_value=limits["Infr_avail"][0]//0.01/100 if limits["Infr_avail"][1]!=0 else 0,
    ...
    with col2:
        Infr_location = st.number_input(
            ...
            min_value=limits["Infr_location"][0]//0.01/100 if limits["Infr_location"][1]!=0 else 0,
        ...
        Infr_time = st.number_input(
            "Infrastructure-Time",
            min_value=limits["Infr_time"][0]//0.01/100 if limits["Infr_time"][1]!=0 else 0,
        ...
        DaysSupply_EV_ICE_Ratio_c = st.number_input(
            ...
            min_value=limits["DaysSupply_EV_ICE_Ratio_c"][0]//0.01/100 if limits["DaysSupply_EV_ICE_Ratio_c"][1]!=0 else 0,
        ...
        DaysToTurn_EV_ICE_Ratio = st.number_input(
            ...
            min_value=limits["DaysToTurn_EV_ICE_Ratio"][0]//0.01/100 if limits["DaysToTurn_EV_ICE_Ratio"][1]!=0 else 0,
